...
<body>
    ...
    <footer>
        <hr>
        Designed and Developed by Kishan Shree B &copy; 2023
    </footer>
    ...
    <header>
        ...
        <div class="search"><input type="text" placeholder="Enter to Search">
            ...
            <div class="contain">
                <table >
                    <tr>
                        <td><img src="micro.jpeg" height="200px" width="200px">
                            <p><b>Unity</b><br>
                                &nbsp;&nbsp;&nbsp;Game Development<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Platform
                        </p></td>
                        <td><img src="apple.jpeg" height="200px" width="200px"><br>
                            <p><b>Salesforce</b><br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cloud-based<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;CRM
                        </p></td>
                    ...
                    <tr>
                        ...
                        <td><img src="google.jpeg" height="200px" width="200px"><br>
                            <p><b>Salesforce</b><br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cloud-based<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;CRM
                        </p></td>
...
<body>
    <header>
        ...
        <div class="search"><input type="text" placeholder="Enter to Search">
            <button>Search</button></div>
        <div class="cirpic">
            <img class="small border" src="my photo.png" width="500px">
            <img class="small border" src="dhoni.jpeg" width="500px" >
            <img class="small border" src="virat.jpeg" width="500px">
            <img class="small border" src="neymar.jpeg" width="500px" >
            <img class="small border" src="dq.jpeg" width="500px">
            <img class="small border" src="vijay.jpeg" width="500px" >
        </div>
        <div class ="text">
...
<head>
    ...
    <body>
        ...
        <div class="vl"></div>
                ...
                <footer>
                    <hr>
                    Designed and Developed by Kishan Shree B</B>&copy; 2023
                    </footer>
